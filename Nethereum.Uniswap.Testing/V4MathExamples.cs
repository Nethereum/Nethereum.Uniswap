...
namespace Nethereum.Uniswap.Testing
{
    public class V4MathExamples
    {
        ...
        {
            // At tick 0, price = 1
            var sqrtPriceX96 = V4TickMath.GetSqrtRatioAtTick(0);
        ...
        public void TickMath_GetSqrtRatioAtTick_PositiveTick_ReturnsHigherPrice()
        {
            ...
            var sqrtPriceAt100 = V4TickMath.GetSqrtRatioAtTick(100);
            var sqrtPriceAt0 = V4TickMath.GetSqrtRatioAtTick(0);
        ...
        public void TickMath_GetSqrtRatioAtTick_NegativeTick_ReturnsLowerPrice()
        {
            ...
            var sqrtPriceAtMinus100 = V4TickMath.GetSqrtRatioAtTick(-100);
            var sqrtPriceAt0 = V4TickMath.GetSqrtRatioAtTick(0);
        ...
        {
            var sqrtPriceX96 = V4TickMath.GetSqrtRatioAtTick(V4TickMath.MIN_TICK);
        ...
        {
            var sqrtPriceX96 = V4TickMath.GetSqrtRatioAtTick(V4TickMath.MAX_TICK);
        ...
        public void TickMath_GetSqrtRatioAtTick_BelowMinTick_ThrowsException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                V4TickMath.GetSqrtRatioAtTick(V4TickMath.MIN_TICK - 1));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                V4TickMath.GetSqrtRatioAtTick(V4TickMath.MAX_TICK + 1));
        }
        ...
        public void TickMath_GetSqrtRatioAtTick_ValidRanges()
        {
            ...
            var sqrtPriceAtMinus1000 = V4TickMath.GetSqrtRatioAtTick(-1000);
            var sqrtPriceAt0 = V4TickMath.GetSqrtRatioAtTick(0);
            var sqrtPriceAt100 = V4TickMath.GetSqrtRatioAtTick(100);
            var sqrtPriceAt1000 = V4TickMath.GetSqrtRatioAtTick(1000);
        ...
        public void TickMath_TickValues_ConsistentWithPriceCalculator()
        {
            ...
            var price = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(sqrtPriceX96);
        ...
        {
            var tick = V4TickMath.GetTickAtSqrtRatio(V4TickMath.MIN_SQRT_RATIO);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                V4TickMath.GetTickAtSqrtRatio(V4TickMath.MIN_SQRT_RATIO - 1));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                V4TickMath.GetTickAtSqrtRatio(V4TickMath.MAX_SQRT_RATIO));
        }
        ...
        public void TickMath_GetNearestUsableTick_RoundsToTickSpacing()
        {
            ...
            var usableTick = V4TickMath.GetNearestUsableTick(tick, tickSpacing);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                V4TickMath.GetNearestUsableTick(100, 0));

            Assert.Throws<ArgumentOutOfRangeException>(() =>
                V4TickMath.GetNearestUsableTick(100, -10));
        }
        ...
        public void LiquidityMath_GetLiquidityForAmount0_ValidInputs()
        {
            ...
            var sqrtRatioAX96 = V4TickMath.GetSqrtRatioAtTick(-1000);
            var sqrtRatioBX96 = V4TickMath.GetSqrtRatioAtTick(1000);
            var amount0 = Web3.Web3.Convert.ToWei(1); // 1 token0

            var liquidity = V4LiquidityMath.GetLiquidityForAmount0(sqrtRatioAX96, sqrtRatioBX96, amount0);
        ...
        public void LiquidityMath_GetLiquidityForAmount1_ValidInputs()
        {
            ...
            var liquidity = V4LiquidityMath.GetLiquidityForAmount1(sqrtRatioAX96, sqrtRatioBX96, amount1);
        ...
        public void LiquidityMath_GetAmount0ForLiquidity_ValidInputs()
        {
            ...
            var amount0 = V4LiquidityMath.GetAmount0ForLiquidity(sqrtRatioAX96, sqrtRatioBX96, liquidity);
        ...
        public void LiquidityMath_GetAmount1ForLiquidity_ValidInputs()
        {
            ...
            var amount1 = V4LiquidityMath.GetAmount1ForLiquidity(sqrtRatioAX96, sqrtRatioBX96, liquidity);
        ...
        public void LiquidityMath_GetAmountsForLiquidity_PriceInRange()
        {
            ...
            var amounts = V4LiquidityMath.GetAmountsForLiquidity(sqrtRatioCurrentX96, sqrtRatioAX96, sqrtRatioBX96, liquidity);
        ...
        public void LiquidityMath_GetAmountsForLiquidity_PriceBelowRange()
        {
            ...
            var sqrtRatioAX96 = V4TickMath.GetSqrtRatioAtTick(100);
            var sqrtRatioBX96 = V4TickMath.GetSqrtRatioAtTick(1000);
            var liquidity = BigInteger.Parse("1000000000000000000");
        ...
        public void LiquidityMath_GetAmountsForLiquidityByTicks_ValidInputs()
        {
            ...
            var amounts = V4LiquidityMath.GetAmountsForLiquidityByTicks(sqrtRatioCurrentX96, tickLower, tickUpper, liquidity);
        ...
        public void LiquidityMath_GetLiquidityForAmounts_PriceInRange()
        {
            ...
            var sqrtRatioCurrentX96 = V4TickMath.GetSqrtRatioAtTick(0);
            var sqrtRatioAX96 = V4TickMath.GetSqrtRatioAtTick(-1000);
            var sqrtRatioBX96 = V4TickMath.GetSqrtRatioAtTick(1000);
            var amount0 = Web3.Web3.Convert.ToWei(1);
            var amount1 = Web3.Web3.Convert.ToWei(1);

            var liquidity = V4LiquidityMath.GetLiquidityForAmounts(sqrtRatioCurrentX96, sqrtRatioAX96, sqrtRatioBX96, amount0, amount1);
        ...
        public void LiquidityMath_RoundTrip_Amount0()
        {
            ...
            var liquidity = V4LiquidityMath.GetLiquidityForAmount0(sqrtRatioAX96, sqrtRatioBX96, originalAmount0);
            var resultAmount0 = V4LiquidityMath.GetAmount0ForLiquidity(sqrtRatioAX96, sqrtRatioBX96, liquidity);
        ...
        public void LiquidityMath_RoundTrip_Amount1()
        {
            ...
            var liquidity = V4LiquidityMath.GetLiquidityForAmount1(sqrtRatioAX96, sqrtRatioBX96, originalAmount1);
            var resultAmount1 = V4LiquidityMath.GetAmount1ForLiquidity(sqrtRatioAX96, sqrtRatioBX96, liquidity);
        ...
        public void LiquidityMath_SwappedRatios_AutomaticSorting()
        {
            ...
            var liquidity1 = V4LiquidityMath.GetLiquidityForAmount0(sqrtRatioAX96, sqrtRatioBX96, amount0);

            // Call with swapped order - should auto-sort and give same result
            var liquidity2 = V4LiquidityMath.GetLiquidityForAmount0(sqrtRatioBX96, sqrtRatioAX96, amount0);
        ...
        public void PriceCalculator_CalculatePriceFromSqrtPriceX96_WithDecimals()
        {
            ...
            var priceETH_USDC = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(sqrtPriceX96, 18, 6);
            Assert.True(priceETH_USDC > 0);

            // 18 decimals / 18 decimals (e.g., ETH/DAI)
            var priceETH_DAI = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(sqrtPriceX96, 18, 18);
            Assert.True(priceETH_DAI > 0);

            // 6 decimals / 6 decimals (e.g., USDC/USDT)
            var priceUSDC_USDT = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(sqrtPriceX96, 6, 6);
        ...
        public void PriceCalculator_RoundTrip_Price()
        {
            ...
            var sqrtPriceX96 = V4PriceCalculator.CalculateSqrtPriceX96FromPrice(originalPrice);
            var resultPrice = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(sqrtPriceX96);
        ...
        public void PriceCalculator_RoundTrip_PriceWithDecimals()
        {
            ...
            var sqrtPriceX96 = V4PriceCalculator.CalculateSqrtPriceX96FromPrice(originalPrice, decimals0, decimals1);
            var resultPrice = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(sqrtPriceX96, decimals0, decimals1);
        ...
        public void PriceCalculator_CreatePoolPrice_ValidInputs()
        {
            ...
            var poolPrice = V4PriceCalculator.CreatePoolPrice(poolId, currency0, currency1, sqrtPriceX96, tick);
        ...
        public void PriceCalculator_CreatePoolPrice_WithDecimals()
        {
            ...
            var poolPrice = V4PriceCalculator.CreatePoolPrice(poolId, currency0, currency1, sqrtPriceX96, tick, 18, 6);
        ...
        public void PriceCalculator_ZeroSqrtPrice_ReturnsZero()
        {
            ...
            var price = V4PriceCalculator.CalculatePriceFromSqrtPriceX96(BigInteger.Zero);
